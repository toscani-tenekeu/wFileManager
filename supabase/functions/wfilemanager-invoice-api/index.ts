...
async function renderPdf(params: {
  ...
  page.drawLine({ start: { x: 48, y: 539 }, end: { x: 547, y: 539 }, thickness: 1, color: rgb(0.82, 0.84, 0.88) });
  draw(params.description, 48, 512, 11);
  draw(`$${params.amountUsd.toFixed(2)} USD`, 455, 512, 11, true);
  page.drawLine({ start: { x: 48, y: 490 }, end: { x: 547, y: 490 }, thickness: 1, color: rgb(0.82, 0.84, 0.88) });
